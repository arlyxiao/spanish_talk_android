...
public class CookieHelper {
	public static String getStringFromCookie(CookieStore cookieStore) {
	    ...
	    try {
	      ...
	      Log.e("CookieHelper", "parse_string cookie json ½âÎö³ö´í", e);
	      return "";
	    }
	  }

	  public static CookieStore getCookieFromString(String cookies_string){
